export default function BoxAbdPage() {
    return (
        <div className="w-[260px] h-[383px] flex flex-col items-center bg-white p-5">
            <div className="h-[1400px] w-[140px] flex justify-center items-center bg-[#cbcaca] rounded-[50%]">
            ...
            <div className="mt-[30px]">
                <button className="w-[156px] h-[55px] bg-black text-white font-bold text-[14px]">STOP WITH ME</button>
            </div>
        </div>
    );
}